            ...
            },
            {
              children: (
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative z-10 text-center p-6 md:p-8 bg-black bg-opacity-40 rounded-lg max-w-4xl mx-auto">
                    <h1 className="text-5xl md:text-7xl font-extrabold leading-tight mb-4 drop-shadow-lg text-white">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      <Link href="/donate" className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-full transition duration-300 transform hover:scale-105 shadow-lg">
                        Donate Now
                      </Link>
                      <Link href="/about" className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white font-bold py-3 px-8 rounded-full transition duration-300 transform hover:scale-105 shadow-lg border border-white">
                        Learn More
                      </Link>
                    </div>
                  </div>
            ...
            },
            {
              children: (
                <div className="absolute inset-0 pointer-events-none">
                  <Parallax translateY={[50, -50]} className="absolute top-20 left-[10%] opacity-30">
                    <Globe className="h-24 w-24 text-white" />
                  </Parallax>
                  <Parallax translateY={[20, -80]} className="absolute top-40 right-[15%] opacity-20">
                    <FileText className="h-32 w-32 text-white" />
                  </Parallax>
                  <Parallax translateY={[80, -20]} className="absolute bottom-40 left-[20%] opacity-25">
        ...
        <section className="relative py-20 px-4 bg-green-50 text-gray-800 overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            <Parallax translateY={[10, -10]} opacity={[0.8, 1]} scale={[0.9, 1]}>
              <h2 className="text-4xl font-bold mb-6 text-center">Our Fundraising Progress</h2>
            </Parallax>
              ...
              <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
                <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                  <div className="text-center md:text-left mb-4 md:mb-0">
                    <p className="text-gray-600">Fundraising Goal</p>
                    <p className="text-3xl font-bold text-gray-800">Nrs 100,000</p>
                  </div>
                  <div className="text-center md:text-right">
                    <p className="text-gray-600">Raised So Far</p>
                    <p className="text-3xl font-bold text-green-600">Nrs 0</p>
                  </div>
                </div>
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Parallax translateY={[20, -20]} scale={[0.9, 1]} className="flex">
                <div className="p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-xl transition duration-300 h-full">
                  ...
                  <h3 className="text-2xl font-semibold mb-3 text-green-600">Education</h3>
                  <p className="text-gray-700">Supporting schools, providing scholarships, and developing educational resources for children in rural areas.</p>
                </div>
              </Parallax>
              ...
              <Parallax translateY={[15, -15]} scale={[0.9, 1]} className="flex">
                <div className="p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-xl transition duration-300 h-full">
                  ...
                  <h3 className="text-2xl font-semibold mb-3 text-green-600">Healthcare</h3>
                  <p className="text-gray-700">Improving access to quality healthcare services, medical supplies, and health education in underserved communities.</p>
                </div>
              </Parallax>
              ...
              <Parallax translateY={[10, -10]} scale={[0.9, 1]} className="flex">
                <div className="p-6 bg-gray-50 rounded-lg shadow-md hover:shadow-xl transition duration-300 h-full">
                  ...
                  <h3 className="text-2xl font-semibold mb-3 text-green-600">Infrastructure</h3>
                  <p className="text-gray-700">Building sustainable infrastructure including clean water systems, renewable energy, and community facilities.</p>
                </div>
              </Parallax>
            </div>
          </div>
