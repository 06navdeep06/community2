  ...
  return (
    <ParallaxProvider>
      <div className="relative">
        <Parallax className="custom-class" translateY={[-20, 20]}>
        ...
        <div className="container mx-auto px-4 py-16 bg-white shadow-lg rounded-lg -mt-20 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {images.map((image, index) => (
              <Parallax key={index} translateY={[index % 2 === 0 ? -10 : 10, index % 2 === 0 ? 10 : -10]} className="overflow-hidden rounded-lg shadow-xl transform transition duration-500 hover:scale-105 hover:shadow-2xl">
                <Image src={image} alt="Gallery Image" width={400} height={256} className="w-full h-64 object-cover" />
              </Parallax>
            ))}
          </div>
        </div>
